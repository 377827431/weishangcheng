...
return  array(
    ...
    'APP_SUB_DOMAIN_RULES'  =>  require_once THINK_PATH.'/Conf/domain_rules.php',// 子域名部署规则
    'APP_DOMAIN_SUFFIX'     =>  '', // 域名后缀 如果是com.cn net.cn 之类的后缀必须设置    
    'ACTION_SUFFIX'         =>  '', // 操作方法后缀
    'MULTI_MODULE'          =>  true, // 是否允许多模块 如果为false 则必须设置 DEFAULT_MODULE
    'MODULE_DENY_LIST'      =>  array('Common','Runtime'), // 禁止访问的模块
    'MODULE_ALLOW_LIST'     =>  array('Admin', 'Pay', 'Seller', 'H5', 'Service'),
    'CONTROLLER_LEVEL'      =>  1,
    ...
    /* 数据库设置 */
    'DB_TYPE'               =>  'mysql',     // 数据库类型
    'DB_HOST'               =>  'rm-uf6ae6913xuy91a48o.mysql.rds.aliyuncs.com', // 服务器地址
//    'DB_NAME'               =>  'weishangchengline2',          // 数据库名
    ...
    'URL_PATHINFO_FETCH'    =>  'REQUEST_URI', // 用于兼容判断PATH_INFO 参数的SERVER替代变量列表
    'URL_REQUEST_URI'       =>  'REQUEST_URI', // 获取当前页面地址的系统变量 默认为REQUEST_URI
    'URL_HTML_SUFFIX'       =>  '',  // URL伪静态后缀设置
    'URL_DENY_SUFFIX'       =>  'ico|png|gif|jpg|jpeg|bmp', // URL禁止访问的后缀设置
