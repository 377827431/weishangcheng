...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '<div class="area_roll" col_num="'+col_num+'">' +
                    '<div>' +
        ...
        finish: function(e) {
            ...
            //yangdonglei append
            var col_num = this.trigger.getAttribute('col_num');
            if(col_num == 2){
                _self.trigger.innerText = ((cityText)?(cityText):(''))+ ((countyText)?(',' + countyText):(''));
            }else if(col_num == 1){
                _self.trigger.innerText = ((countyText)?(countyText):(''));
            }else{
            ...
            if(this.valueTo){
                if(col_num == 2){
                    this.valueTo.value= ((cityCode)?(cityCode):('')) + ((countyCode)?(',' + countyCode):(''));
                }else if(col_num == 1){
                    this.valueTo.value= ((countyCode)?(countyCode):(''));
                }else {
