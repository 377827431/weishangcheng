(function ($) {
    ...
    Pagination.prototype = {
        ...
        _drawInner: function () {
            ...
            var tpl = '<ul>' + '<li class="prev' + (this.currentPage - 1 <= 0 ? ' disabled' : ' ') + '"><a href="javascript:;" data="' + (this.currentPage - 1) + '">上一页</a></li>';
            if (this.pages <= this.displayPage || this.pages == this.displayPage + 1) {
                ...
                if (this.currentPage < this.displayPage - 1) {
                    ...
                    var frontPage,
                        backPage,
                        middle = (this.displayPage - 1) / 2;
                    if ( (this.displayPage - 1) % 2 == 0 ) {
            ...
            tpl += '<li class="next' + (this.currentPage + 1 > this.pages ? ' disabled' : ' ') + '"><a href="javascript:;" data="' + (this.currentPage + 1) + '">下一页</a></li>' + '</ul>';
            
            if(1==1 || this.pages > this.displayPage){
        ...
        //值传递
        _drawCtrl: function () {
            var tpl = '<div>&nbsp;<span>'+ this.currentPage +'/' + this.pages + '</span>&nbsp;<span>'+ this.itemsCount +'条</span>&nbsp;&nbsp;<span style="color:#888">到</span>&nbsp;<input type="text" class="page-num"/>&nbsp;<span style="color:#888">页</span>&nbsp;&nbsp;<button class="page-confirm">确定</button></div>';
            return tpl;
        },
