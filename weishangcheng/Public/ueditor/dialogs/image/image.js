...
(function () {
    ...
    OnlineImage.prototype = {
        ...
        pushData: function (list) {
            var i, item, img, icon, width_height, _this = this,
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    width_height = document.createElement('div');
                    ...
                    domUtils.addClass(width_height, 'image-meta');
                    width_height.innerHTML = list[i].width + 'x' + list[i].height;

                    item.appendChild(img);
                    item.appendChild(icon);
                    item.appendChild(width_height);
